    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        switch(action){
            ...
            case "getUserById":
                ...
                request.setAttribute("beanUser", new DaoUser().findById(id));
            ...
            case "update":
                ...
                String lastname1 = request.getParameter("lastname")!= null ? request.getParameter("lastname") : "";
                ...
                int role1 = Integer.parseInt(request.getParameter("role")!= null ? request.getParameter("role") : "");
                ...
                break;
            case "delete":
                long id2 = Long.parseLong(request.getParameter("id")!= null ? request.getParameter("id") : "");
